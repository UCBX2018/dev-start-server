...
const Introduction = () => (
  <div className="intro-wrapper">
    <div className="text-wrapper-for-developer col-4 container text-center">
    ...
    <div className="text-wrapper-for-entrepreneur col-4 container text-center">
      <h2>Dev Start entrepreneurs</h2>
      <p>
        Post your project and hire developer who wants your project in a minute.
      </p>
      <p>
